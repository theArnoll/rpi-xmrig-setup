...
```shell
wget https://raw.githubusercontent.com/theArnoll/rpi-xmrig-setup/main/setup_miner.sh && chmod +x rpi-xmrig-setup && ./rpi-xmrig-setup
```

or the short link version:

```shell
wget https://pse.is/rpi-xmrig-setup && chmod +x rpi-xmrig-setup && ./rpi-xmrig-setup
```
